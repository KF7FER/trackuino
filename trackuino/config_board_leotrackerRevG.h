...
// --------------------------------------------------------------------------
// THIS IS THE leoTracker (REVISION "G") BOARD-SPECIFIC CONFIGURATION FILE
...
// data (in millis)
#define GPS_POWER_SLEEP_TIME 200
...
// Uncomment out the following define to use microSD support
//#define USE_MICROSD
